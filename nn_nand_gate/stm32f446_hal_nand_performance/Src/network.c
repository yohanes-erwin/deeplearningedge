...
#define AI_NETWORK_MODEL_SIGNATURE     "2e3da697972fc8fab341d62973f1249b"
...
#define AI_TOOLS_DATE_TIME   "Tue Jul 23 20:59:33 2019"
...
AI_TENSOR_OBJ_DECLARE(
  dense_3_weights,
  AI_SHAPE_INIT(1, 1, 1, 3),
  AI_STRIDE_INIT(12, 12, 12, 4),
...
AI_TENSOR_OBJ_DECLARE(
  dense_2_weights,
  AI_SHAPE_INIT(1, 1, 3, 3),
  AI_STRIDE_INIT(36, 36, 12, 4),
...
AI_TENSOR_OBJ_DECLARE(
  dense_1_weights,
  AI_SHAPE_INIT(1, 1, 3, 2),
  AI_STRIDE_INIT(24, 24, 8, 4),
